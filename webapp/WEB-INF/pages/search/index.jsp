	...
	<div class="container">
		...
		<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
			...
			<form action="" method="GET"
				class="form col-xs-12 col-sm-12 col-md-12 col-lg-12" role="form">
				<h1>Woogle</h1>
				<div class="form-group">
					<label class="sr-only" for="">label</label> <input type="text"
						class="form-control" id="" placeholder="" name="q">
				</div>
